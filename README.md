...
UFC Complete Dataset (Kaggle) — ufc-master.csv
...
Betting market implied win probability
Strike differential between fighters
ELO rating difference
Reach and height differential
Recent fight form (last 3 fights)
